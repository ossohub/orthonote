...
export function ClinicalToolFrame() {
  ...
  const isToolsRoute = !!slug && ALL_SLUGS.includes(slug);
    ...
    win.postMessage(
      {
        ...
        tool: isToolsRoute && slug ? SLUG_TO_TOOL_CODE[slug] : undefined,
      },
  ...
  useEffect(() => {
    ...
    iframeRef.current?.contentWindow?.postMessage(
      { type: "ossohub-show-tool", tool: SLUG_TO_TOOL_CODE[slug] },
      window.location.origin
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [slug, isToolsRoute]);
  ...
  return (
    <iframe
      ...
      style={{
        ...
        display: isToolsRoute ? "block" : "none",
      }}
